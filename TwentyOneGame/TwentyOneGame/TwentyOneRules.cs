...
namespace TwentyOneGame
{
    ...
    {
        //creating a private dictionary of the values of our 52 cards. Private because we dont want it to be 
        //able to be accessed by our other classes. Its standard to name you dictionaries with _ in front of
        //it as you see there.
        private static Dictionary<Face, int> _cardValues = new Dictionary<Face, int>()
        {
            ...
            [Face.Queen] = 10,
            [Face.King] = 10,
            [Face.Ace] = 1 //we will work on this also being 11 on another part
        };
